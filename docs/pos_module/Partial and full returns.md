...
- Tenant/Branch/Customer/Product exist in core.\* tables.
- POS objects and functions deployed:
  ...
  - Triggers / functions: pos_module.update_on_return (trigger on return_product), pos_module.create_bill, pos_module.check_sale_payment_completion, core.update_timestamp.
